...
// resolveMonsterSwing/performKatanaSwing). Weapon base is deliberately
// lower than the old flat 1-20 roll, since the coefficient above can now
// multiply it up to 2.5x on a big enough margin — keeping the old range
// there would let a strong weapon on a crushing hit one-shot most of a
// 100-HP pool. Bare hands got bumped back up past the old range (buffed
// after players felt too weak unarmed) since 1x is already the lowest
// multiplier in the game — no weapon's own multiplier compounds on top
// of it the way a real weapon's does.
const BARE_HAND_DMG_MIN = 5;
const BARE_HAND_DMG_MAX = 20;
