...
// resolveMonsterSwing/performKatanaSwing) — both bumped up from this
// system's original launch numbers after players felt underpowered;
// weapon base stays above bare-hand base since a weapon's own multiplier
// (0.4-2.5x) already compounds on top of it, unlike bare hands' flat 1x.
const BARE_HAND_DMG_MIN = 5;
const BARE_HAND_DMG_MAX = 20;
const WEAPON_BASE_DMG_MIN = 7; // before weapon.multiplier is applied
const WEAPON_BASE_DMG_MAX = 25;
