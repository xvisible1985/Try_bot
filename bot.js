...
bot.onText(/\/help\b/, (msg) => {
  const text = [
    ...
    '/kuniFun — бафф +50% крит на /kick, 10 мин (кулдаун = 10 мин)',
    '/kuniAlia — бафф +50% уклонение от /kick, 10 мин (кулдаун = 10 мин)',
    '/kuniTama — бафф +25% крит и +25% уклонение, 10 мин (кулдаун = 10 мин)',
    '',
